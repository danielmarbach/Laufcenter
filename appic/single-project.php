		...
		<section class="project-descript-wrap grey-lines">
			<div class="row">
				<div class="span4 project-descript">
					...
					<?php } ?>
					<ul class="font-style-20 pink-text pink-list">
					<?php if (!empty($theContent)) { ?>
						<li>
							<span class="list-item-icon">&#8226;</span><span class="bold"><?php echo __('Description','appic'); ?></span>
							<div class="simple-text-14"><?php echo $theContent; ?></div>
						</li>
					<?php } ?>
					<?php if ($hasAnyDetailsField) { ?>
						<li>
							<span class="list-item-icon">&#8226;</span><span class="bold"><?php echo __('Details','appic'); ?></span>
					...
					<?php if (get_theme_option('project_social_sharing')) { ?>
						<li>
							<span class="list-item-icon">&#8226;</span><span class="bold"><?php echo __('Share', 'appic'); ?></span>

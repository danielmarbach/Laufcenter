...
function appic_woocommerce_catalog_ordering()
{
	...
	$catalog_orderby = apply_filters( 'woocommerce_catalog_orderby', array(
		'menu_order' => __( 'Default sorting', 'appic' ),
		'popularity' => __( 'Sort by popularity', 'appic' ),
		'rating' => __( 'Sort by average rating', 'appic' ),
		'date' => __( 'Sort by newness', 'appic' ),
		'price' => __( 'Sort by price: low to high', 'appic' ),
		'price-desc' => __( 'Sort by price: high to low', 'appic' )
	) );
